...
#define SED1335_CONTROL_PORT	PORTG
#define SED1335_CONTROL_DIR		DDRG
#define	SED1335_CONTROL_PIN		PING

#define SED1335_A0				(1 << PG0)
#define SED1335_WR				(1 << PG1)
#define SED1335_RD				(1 << PG2)
#define SED1335_CS				(1 << PG3)
#define SED1335_RES				(1 << PG4)
